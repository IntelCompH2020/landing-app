...
export class InstallationConfigurationService extends BaseComponent {
	...
	private _services: Partial<Service>[];
	get availableServices(): Partial<Service>[]{
		return this._services;
	}

	private _footerURLS: Partial<FooterUrls>;
	get footerURLS(): Partial<FooterUrls>{
		return this._footerURLS;
	}
	...
	parseResponse(config: any) {
		...
		this._footerURLS = config.footerUrls;
	}
}
